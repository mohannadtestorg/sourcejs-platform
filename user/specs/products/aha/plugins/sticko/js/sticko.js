               ...
               var fixedArea = $(document).outerHeight() - $("footer").outerHeight() - tabsHeight; // get break point for stickiness
                ...
                if($('.dynamic-sticko').length) {
                    $('.dynamic-sticko').each(function () {
                        ...
                        dynamicScrollTop = $(window).scrollTop() + ($("header").css('position') == "fixed" ? $('header').outerHeight() : 0) ;
                        dynamicHeight = $(window).outerHeight() - ($("header").css('position') == "fixed" ? $('header').outerHeight() : 0) ;
                        ...
                        if ($("header").css('position') == "fixed") {
                            if( dynamicScrollTop >= dynamicStickyElement.offset().top ) {
                                ...
                                dynamicStickyElement.css('top', $('header').outerHeight());
                            }
                        } else if($(window).scrollTop() >= dynamicStickyElement.offset().top) {
                            dynamicStickyElement.css('position', 'fixed');
                            dynamicStickyElement.css('top',  0);
                        }
