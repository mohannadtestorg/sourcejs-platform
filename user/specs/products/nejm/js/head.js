...
(function(d) {
  ...
  // add class names
  de.className = de.className.replace(/\bno-js\b/,' js '+A17.browserSpec+(A17.touch ? ' touch' : ' no-touch')+(isIE() ? ' isIE ie'+isIE() : ''));
  ...
  if(A17.browserSpec === 'html4'){
    ...
    s.rel  = 'stylesheet';
    s.title = 'html4css';
    s.href = '/pb-assets/styles/html4css.css';
    h.appendChild(s);
    ...
    // a.open('GET', '/pb-assets/icons/icons.svg', true);
    // a.send();
    // a.onload = function(e) {
