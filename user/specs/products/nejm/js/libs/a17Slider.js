...
(function () {
  ...
  window.A17Slider = function(options) {
    ...
    function init() {
      ...
      if (this_instance_params.sliderContainer == undefined || this_instance_params.sliderInner == undefined || this_instance_params.paginator == undefined ) {
        if (typeof console === "object") {
          console.warn("A17Slider: no sliderContainer, sliderInner or paginator specified");
        }
        return;
      }
      ...
      Array.prototype.forEach.call(slides, function(slide, i){
        ...
        Array.prototype.forEach.call(slide_links, function(link, i){
          link.addEventListener("mousedown",function(event){
            // fiddling with focus to stop unexpected focus events scrolling the carousel
            allowFocus = false;
            setTimeout(function(){
              allowFocus = true;
            },100);
